...
class MainShow(Main):
    """
        axf_mainshow(trakid,img,name,categoryid,)
    """
...
class Cart(models.Model):
    c_user = models.ForeignKey(AXFUser, on_delete=models.DO_NOTHING)
    c_goods = models.ForeignKey(Goods, on_delete=models.DO_NOTHING)
...
class Order(models.Model):
    o_user = models.ForeignKey(AXFUser,on_delete=models.DO_NOTHING)
...
class OrderGoods(models.Model):
    o_order = models.ForeignKey(Order,on_delete=models.DO_NOTHING)
    o_goods = models.ForeignKey(Goods,on_delete=models.DO_NOTHING)
